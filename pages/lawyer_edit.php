...
$strSQL = "SELECT * FROM `lawyer` WHERE `lawyer_id` = '$lawyer_id'";
...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="notis_list.php"><span class="active">Lawyer</span></a></li>
...
<div class="row">
        ...
        <button type="button" class="btn btn-app flat"  onClick="goHref('lawyer_select.php<?php echo $doc_id ?>')" title="discard">
            ...
            <div class="box">
            	<div class="box-header with-border">
                  <h3 class="box-title">Lawyer Info</h3>
                ...
                <div class="box-body">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" id="lawyer_name" name="lawyer_name" class="form-control" placeholder="Name" value="<?php echo $objResult['lawyer_name'];?>" maxlength="100" onChange="form_autosave('<?php echo $id;?>','<?php echo $table ?>','<?php echo $where_f ?>',this)" required />
                    </div> 
                    <div class="col-md-6">
                        <label>รหัสบัตรประชาชน <span class="text-red">*</span></label>
                        <input type="text" id="lawyer_tex_no" name="lawyer_tex_no" class="form-control" placeholder="0000000000000" value="<?php echo $objResult['lawyer_tex_no'];?>" maxlength="20" onChange="form_autosave('<?php echo $id;?>','<?php echo $table ?>','<?php echo $where_f ?>',this)" />
                    </div> 
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <label>ใบอนุญาตให้เป็นทนายความเลขที่ <span class="text-red">*</span></label>
                        <input type="text" id="submit_no" name="submit_no" class="form-control" placeholder="" value="<?php echo $objResult['submit_no'];?>" maxlength="20" onChange="form_autosave('<?php echo $id;?>','<?php echo $table ?>','<?php echo $where_f ?>',this)"  />
                    </div> 
                    <div class="col-md-6">
                        <label>ได้รับอนุญาตให้ว่าความ <span class="text-red">*</span></label>
                        <input type="text" id="submit_info" name="submit_info" class="form-control" placeholder="" value="<?php echo $objResult['submit_info'];?>" maxlength="30" onChange="form_autosave('<?php echo $id;?>','<?php echo $table ?>','<?php echo $where_f ?>',this)"  />
                    </div>            
            ...
            <div class="box">
            	<div class="box-header with-border">
                  <h3 class="box-title">Lawyer Current Info</h3>
                  <div class="box-tools pull-right">
                     <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
                  </div>
                </div>
            ...
            <div class="box">
            	<div class="box-header with-border">
                  <h3 class="box-title">Lawyer Work Info</h3>
                  <div class="box-tools pull-right">
                     <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
                  </div>
                </div>
